...
struct TabBarHomeScreen: View {
    ...
    /// View Properties
    @State private var activeTab: Tab = .objectives
    ...
    func CustomTabBar(_ tint: Color = .clear, _ inactiveTint: Color = .accentColor) -> some View {
        /// Moving all the Remaining Tab Item's to Bottom
        HStack(alignment: .bottom, spacing: 0) {
            ForEach(Tab.allCases, id: \.rawValue) {
                TabItem(
                    tint: Color.orange,
                    inactiveTint: Color.accentColor,
                    tab: $0,
                    animation: animation,
                    activeTab: $activeTab,
